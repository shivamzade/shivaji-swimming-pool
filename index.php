...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title><?php echo POOL_NAME; ?> - Best Swimming Coaching in Mumbai</title>
        <meta content="width=device-width, initial-scale=1.0" name="viewport">
        <meta content="swimming pool, swimming coaching, shivaji pool, swimming classes mumbai" name="keywords">
        <meta content="Professional swimming coaching and recreational facilities at Shivaji Swimming Pool." name="description">
                        ...
                        <div class="row g-5 align-items-center">
                            <div class="col-xl-7 fadeInLeft animated" data-animation="fadeInLeft" data-delay="1s" style="animation-delay: 1s;">
                                <div class="text-start">
                                    <h4 class="text-primary text-uppercase fw-bold mb-4">Welcome To <?php echo POOL_NAME; ?></h4>
                                    <h1 class="display-4 text-uppercase text-white mb-4">State-of-the-Art Swimming Facility</h1>
                                    <p class="mb-4 fs-5">Learn from the best coaches and enjoy a world-class swimming experience in the heart of Mumbai.
                                    </p>
                ...
                <div class="carousel-caption">
                    <div class="container py-4">
                        <div class="row g-5 align-items-center">
                            <div class="col-xl-7 fadeInLeft animated" data-animation="fadeInLeft" data-delay="1s" style="animation-delay: 1s;">
                                <div class="text-start">
                                    <h4 class="text-primary text-uppercase fw-bold mb-4">Master Your Strokes</h4>
                                    <h1 class="display-4 text-uppercase text-white mb-4">Join Our Professional Coaching Batch</h1>
                                    <p class="mb-4 fs-5">From beginners to competitive swimmers, we offer specialized training for all age groups.
                                    </p>
                                    <div class="d-flex flex-shrink-0">
                                        <a class="btn btn-primary rounded-pill text-white py-3 px-5" href="package.php">Our Packages</a>
                                    </div>
                ...
                <div class="row g-5">
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay="0.2s">
                        <div>
                            ...
                            <p class="mb-5">With over 20 years of experience, we provide a safe, clean, and professional environment for swimmers of all levels. Our facility features olympic-sized pools and certified trainers to help you achieve your goals.
                            </p>
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="d-flex">
